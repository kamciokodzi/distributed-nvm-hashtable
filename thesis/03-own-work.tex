...
\section{Evaluation}
    ...
    \subsection{Performance tests}
        ...
        % \tk{A table is OK, but a plot would be much better -- it is easier to see whether the implementation scales at all and how good is scalability. You should add a commentary. You should state what computer environment you used to conduct those tests.}
        ...
        It locks the mutex in a shared mode only and does not \tk{modify any of} change the data. 
...
\section{Conclusions}
    ...
    Unsurprisingly, the \NvmHashMap turns out to be slower than a hash map which uses traditional RAM. \tk{by how much?}
